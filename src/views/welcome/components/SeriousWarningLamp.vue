...
const alarmList = computed(() => [
  { label: "充电高温", count: s.value.cot ?? 0, active: (s.value.cot ?? 0) > 0, icon: "temp", color: "#FF6B9D" },
  { label: "放电高温", count: s.value.dot ?? 0, active: (s.value.dot ?? 0) > 0, icon: "temp", color: "#FF6B9D" },
  { label: "MOS高温", count: s.value.mot ?? 0, active: (s.value.mot ?? 0) > 0, icon: "temp", color: "#FFD93D" },
  { label: "充电MOS失效", count: s.value.cmosfault ?? 0, active: (s.value.cmosfault ?? 0) > 0, icon: "mos", color: "#F72585" },
  { label: "放电MOS失效", count: s.value.dmosfault ?? 0, active: (s.value.dmosfault ?? 0) > 0, icon: "mos", color: "#F72585" },
  { label: "放电短路", count: s.value.dsc ?? 0, active: (s.value.dsc ?? 0) > 0, icon: "short", color: "#FF003C" }
]);
