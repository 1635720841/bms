<template>
	<el-row class="page-table-row">
		<div class="page-table-wrap">
			<el-table
				:data="data"
				:class="['page-table', { 'h5-right-fixed-enable': enableMobileRightFixedCollapse }]"
...
:deep(.el-table .cell) {
	max-height: 40px;
	white-space: nowrap;
	padding: var(--page-table-cell-padding-y, 8px) var(--page-table-cell-padding-x, 10px);
}
:deep(.el-table td.el-table__cell) {
	padding: 0;
}
